...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/anggradiantoro/vipkuh/perizinan/main/main/allow > /root/tmp
...
Name=$(curl -sS raw.githubusercontent.com/anggradiantoro/vipkuh/main/main/allow | grep $MYIP | awk '{print $2}')
