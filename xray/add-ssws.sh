...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/Pedoindo/scvip/perizinan/main/main/allow > /root/tmp
...
Name=$(curl -sS raw.githubusercontent.com/Pedoindo/scvip/main/main/allow | grep $MYIP | awk '{print $2}')
...
echo -e "\\E[0;41;36m      Buat Sodosok WS/gRPC Account    \E[0m"
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
